...
public class Drive_Old implements Updatable {
	
	private static class DriveTask implements Runnable
	{       
        private Drive_Old _d;

        DriveTask(Drive_Old d)
        {
            _d = d;
        }
	...
	private static final Drive_Old instance = new Drive_Old();
     ...
     * @return The Drive.
     */
    public static Drive_Old getInstance()
    {
        return Drive_Old.instance;
    }
