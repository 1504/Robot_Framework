 ...
 */
	...
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_MID_SEQUENCES = {{-17.8, AUTON_DEFAULT_SPEED, 0.0, 13, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_MID_SEQUENCES = {{17.8, AUTON_DEFAULT_SPEED, 0.0, 13, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_LEFT_SEQUENCES = {{37.0, AUTON_DEFAULT_SPEED, 0.0, 13, 7500}};
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_RIGHT_SEQUENCES = {{-37.0, AUTON_DEFAULT_SPEED, 0.0, 13, 7500}};
