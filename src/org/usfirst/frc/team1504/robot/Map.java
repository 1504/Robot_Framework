 ...
 */
	...
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_MID_SEQUENCES = {{-17.8, AUTON_DEFAULT_SPEED, 0.0, 13, 6500}, {0.0, 0.0, 0.0, 3, 50}, {-32.735, AUTON_DEFAULT_SPEED, 0.0, 13, 2000}}; //Move to switch at an angle and eject cube
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_MID_SEQUENCES = {{17.8, AUTON_DEFAULT_SPEED, 0.0, 13, 6500}, {0.0, 0.0, 0.0, 3, 50}, {32.735, AUTON_DEFAULT_SPEED, 0.0, 13, 2000}}; //Move to switch at an angle and eject cube
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_LEFT_SEQUENCES = {{37.0, AUTON_DEFAULT_SPEED, 0.0, 13, 7500}, {0.0, 0.0, 0.0, 3, 50}, {32.735, AUTON_DEFAULT_SPEED, 0.0, 13, 2000}}; //Move to switch at an angle and eject cube
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_RIGHT_SEQUENCES = {{-37.0, AUTON_DEFAULT_SPEED, 0.0, 13, 7500}, {0.0, 0.0, 0.0, 3, 50}, {-32.735, AUTON_DEFAULT_SPEED, 0.0, 13, 2000}}; //Move to switch at an angle and eject cube
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_RIGHT_OR_LEFT_SWITCH_FROM_LEFT = {{0, (AUTON_DEFAULT_SPEED), 0.0, 13, 3000}, {0.0, 0.0, 0.0, 3, 50}}; //Move straigh to switch and eject cube
	...
	public static final double[][] PICKUP_FROM_MID = {{0.0, 0.0, 0.5, 0, 1000}, {0.0, 0.0, 0.0, 2, 50}, {0.0, 0.0, 0.0, 6, 50}, {0.0, (-1*(AUTON_DEFAULT_SPEED)), 0.0, 13, 1500}, {0.0, 0.0, 0.0, 5, 50}, {0.0, 0.0, 0.0, 9, 50}, {0.0, (-1*(AUTON_DEFAULT_SPEED)), 0.0, 13, 1500}, {0.0, 0.0, 0.0, 4, 50}, {0.0, 0.0, 0.0, 2, 50}, {0.0, 0.0, 0.0, 1, 50}, {0.0, 0.0, 0.0, 5, 50}};
	public static final double[][] RIGHT_SCALE_FROM_END_OF_CONTINGENCY_SEQUENCES = {{90.0, (-1*(AUTON_DEFAULT_SPEED)), 0.0, 13, 3000}, {0.0, 0.0, 0.5, 0, 1000}, {0.0, AUTON_DEFAULT_SPEED, 0.0, 13, 3000}, {0.0, 0.0, 0.0, 7, 500}, {0.0, 0.0, 0.0, 3, 100}};
	public static final double[][] LEFT_SCALE_FROM_END_OF_CONTINGENCY_SEQUENCES = {{-90.0, (-1*(AUTON_DEFAULT_SPEED)), 0.0, 13, 3000}, {0.0, 0.0, 0.5, 0, 1000}, {0.0, AUTON_DEFAULT_SPEED, 0.0, 13, 3000}, {0.0, 0.0, 0.0, 7, 500}, {0.0, 0.0, 0.0, 3, 100}};
