 ...
 */
	...
	*/
	...
	public static double[][] SIDE_DELIVERY_SEQUENCES = {{0.0, 0.0, (RETURN_TO_CENTER_DIRECTION*(0.4)), 0, 1000}, {0, AUTON_DEFAULT_SPEED, 0.0, 11, 800}, {0.0, 0.0, 0.0, 2, 100}, {0.0, 0.0, 0.0, 14, 100}, {0.0, 0.0, 0.0, 5, 100}}; //After forwards sequence turn using RETURN_TO_CENTER_DIRECTION multiplier and then move forwards and eject cube into switch
	public static double[][] FORWARD_SEQUENCE = {{0, (AUTON_DEFAULT_SPEED), 0.0, 11, 2800}};
