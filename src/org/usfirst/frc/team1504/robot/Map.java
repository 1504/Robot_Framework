 ...
 */
	...
	*/
	...
	public static final double[][] LEFT_SIDE_DELIVERY_SEQUENCES = {{0.0, 0.0, ((0.4)), 0, 1000}, {AUTON_DEFAULT_SPEED, 0.0, 0.0, 13, 3000}, {0.0, 0.0, 0.0, 2, 100}, {0.0, 0.0, 0.0, 14, 100}, {0.0, 0.0, 0.0, 5, 100}}; //After forwards sequence turn using RETURN_TO_CENTER_DIRECTION multiplier and then move forwards and eject cube into switch
	public static final double[][] RIGHT_SIDE_DELIVERY_SEQUENCES = {{0.0, 0.0, ((-0.4)), 0, 1000}, {AUTON_DEFAULT_SPEED, 0.0, 0.0, 13, 3000}, {0.0, 0.0, 0.0, 2, 100}, {0.0, 0.0, 0.0, 14, 100}, {0.0, 0.0, 0.0, 5, 100}}; //After forwards sequence turn using RETURN_TO_CENTER_DIRECTION multiplier and then move forwards and eject cube into switch
