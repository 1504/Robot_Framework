 ...
 */
	...
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_RIGHT_OR_LEFT_SWITCH_FROM_LEFT = {{0, (AUTON_DEFAULT_SPEED), 0.0, 13, 3000}, {0.0, 0.0, 0.0, 2, 1}, {0.0, 0.0, 0.0, 14, 1}}; //Move straigh to switch and eject cube
