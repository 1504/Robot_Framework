 ...
 */
	...
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_MID_SEQUENCES = {{-32.0, -0.5, 0.0, 0.0, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_MID_SEQUENCES = {{32.0, -0.5, 0.0, 0.0, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_LEFT_SEQUENCES = {{39.0, -0.5, 0.0, 0.0, 7500}};
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_RIGHT_SEQUENCES = {{-39.0, -0.5, 0.0, 0.0, 7500}};
