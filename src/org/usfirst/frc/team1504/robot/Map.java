 ...
 * Auton stuff	
 */
	public static final double[][][] AUTON_RIGHT_DROP_SEQUENCES = {{{0.5, 0.0, 0.0, 0, 3000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}},{{0.25, 0.0, 0.0, 0, 1000},{0.0, 0.0, 0.25, 0, 1000},{0.25, 0.0, 0.0, 0, 3000},{0.0, 25.0, 0.0, 0, 1000},{0.5, 0.0, 0.0, 0, 2000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}}};
     ...
     */
	public static final double[][][] AUTON_LEFT_DROP_SEQUENCES = {{{0.5, 0.0, 0.0, 0, 3000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}},{{0.25, 0.0, 0.0, 0, 1500}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 3500}, {0.0, 0.0, 0.25, 0, 1000}, {0.5, 0.0, 0.0, 0.0, 2000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}}};
     ...
     */
    public static final double[][][] AUTON_MID_DROP_SEQUENCES = {{{0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1750}, {0.0, 0.0, 0.25, 0, 1000}, {0.5, 0.0, 0.0, 0, 2500}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}}, {{0.25, 0.0, 0.0, 0, 1000},{0.0, 0.25, 0.0, 0, 1000},{0.25, 0.0, 0.0, 0, 2000},{0.0, 0.0, 25.0, 0, 1000},{0.5, 0.0, 0.0, 0, 2000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.25, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}}};
	...
	*/
	public static final double[][] AUTON_SCALE_FROM_MID_SEQUENCES = {{0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 2000}, {0.0, 0.0, 0.25, 0, 1000}, {0.25, 0.0, 0.0, 0, 2000}, {0.0, 0.0, 0.25, 0, 1000}, {0.25, 0.0, 0.0, 0, 500}, {0.0, 0.25, 0.0, 0, 1000}, {0.0, 0.0, 0.0, 7, 1000}, {0.5, 0.0, 0.0, 0, 2000}, {-0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.0, 0.0, 8, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 2000}, {0.0, 0.25, 0.0, 0, 1000}, {0.25, 0.0, 0.0, 0, 1000}, {0.0, 0.25, 0.0, 0, 1000}};
	/*From middle and scale is the goal + return to mid (turn right, forward, turn left, forward, turn left, forward, turn right, extend lift, ram, back up, return lift, turn right, forward, turn right, forward, turn right, forward, turn right)
	 */
