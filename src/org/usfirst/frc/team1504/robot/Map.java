...
<<<<<<< HEAD
		...
		*/
=======
>>>>>>> 60a7abe76ba487097a44307cc7f809f0bcb2afbe
/**
 * Elevator / Lift Stuff
 */
 ...
 */
	...
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_MID_SEQUENCES = {{-32.0, -0.5, 0.0, 13, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_MID_SEQUENCES = {{32.0, -0.5, 0.0, 13, 6500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_LEFT_SEQUENCES = {{39.0, -0.5, 0.0, 13, 7500}};
	public static final double[][] CONTINGENCY_LEFT_SWITCH_FROM_RIGHT_SEQUENCES = {{-39.0, -0.5, 0.0, 13, 7500}};
	public static final double[][] CONTINGENCY_RIGHT_SWITCH_FROM_RIGHT_OR_LEFT_SWITCH_FROM_LEFT = {{0.0, -0.5, 0.0, 13, 5000}};
