...
public class AxisCamera_STFU {
   ...
   */
  public AxisCamera_STFU(String cameraHost) {
...
//      int consecutiveErrors = 0;
      ...
      while (!m_done) {
        ...
        try {
          m_cameraSocket = AxisCamera_STFU.this.createCameraSocket(requestString);
          AxisCamera_STFU.this.readImagesFromCamera();
//          consecutiveErrors = 0;
        } catch (IOException e) {
//          consecutiveErrors++;
